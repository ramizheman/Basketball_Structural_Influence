...
action. We graph this terminal-actor relation, rather than passing or assist credit,
...
\begin{itemize}[leftmargin=1.4em,itemsep=0.2em]
 ...
 connector, classifies as \textsc{Role Occupant / Specialist} (not
 \textsc{Connector / Hub}) in all three sample seasons under Eq.~\eqref{eq:taxonomy}, since
