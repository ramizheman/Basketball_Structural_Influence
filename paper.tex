...
With this framework, researchers can ask questions like which offenses would reorganize most
if a key player were hurt, and how much trades can affect a team's offensive identity.
Offensive organization is no longer just coaching intuition. It can be measured.
\end{abstract}
%=============================================================================
...
immediate extension does not require new defender-attribution work: because shaper absence
